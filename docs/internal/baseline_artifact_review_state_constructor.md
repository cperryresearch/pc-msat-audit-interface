...
| 9 | `state_constructor/output/orb_support_window_scale_review_summary.md` | generated/review markdown | support-window-scale review summary | highest language/interpretation risk; inspect first | pending | pending |  |
